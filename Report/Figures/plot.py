...
def plot_perc_err():
   ...
   num_edges = np.genfromtxt('./data/Mean_perc_err_100_workers_num_edges.txt')
   err_w_r = np.genfromtxt('./data/Mean_perc_err_100_workers_perc_err_w_r.txt')
   err_wo_r = np.genfromtxt('./data/Mean_perc_err_100_workers_perc_err_wo_r.txt')
   err_w = np.genfromtxt('./data/Mean_perc_err_100_workers_perc_err_w.txt')
   err_wo = np.genfromtxt('./data/Mean_perc_err_100_workers_perc_err_wo.txt')
   ...
   axes.set_ylabel('percent assignment error')
